# Aula 7.1: Financas descentralizadas (DeFi) e centralizadas (CeFi): KYC reutilizavel, compliance automatizado

## Abertura
Bem-vindo a aula 7.1! Nesta aula, vamos explorar como a identidade descentralizada esta transformando o setor financeiro, tanto nas financas descentralizadas (DeFi) quanto nas centralizadas (CeFi). Veremos como o conceito de KYC reutilizavel elimina friccoes para usuarios e instituicoes, e como o compliance automatizado pode reduzir custos e aumentar a seguranca do sistema financeiro global.
