# Aula 4.2: Recuperacao de chaves: perda da carteira, social recovery, multisig

## Abertura
Bem-vindo a aula 4.2! Nesta aula, vamos enfrentar uma das questoes mais criticas da identidade descentralizada: o que acontece quando voce perde o acesso as suas chaves privadas? Diferente de sistemas tradicionais onde basta clicar em "esqueci minha senha", em sistemas descentralizados a perda de chaves pode significar a perda permanente da identidade. Vamos explorar as solucoes que tornam esse cenario gerenciavel.
