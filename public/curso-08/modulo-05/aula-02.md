# Aula 5.2: Linguagens Suportadas no Ecossistema de Identidade Descentralizada

## Abertura
Bem-vindo a aula 5.2! Nesta aula, vamos analisar as quatro linguagens de programacao mais relevantes para o desenvolvimento de solucoes de identidade descentralizada: TypeScript/JavaScript, Rust, Go e Python. Cada uma ocupa um nicho especifico no ecossistema, e entender seus pontos fortes e limitacoes e fundamental para tomar decisoes arquiteturais corretas.
