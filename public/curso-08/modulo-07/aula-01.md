# Aula 7.1: Modelos de ameaca: DID hijacking, ataques a chaves, Sybil, grinding attacks

## Abertura
Bem-vindo a aula 7.1! Nesta aula, vamos mergulhar nos modelos de ameaca que afetam sistemas de identidade descentralizada. Compreender como atacantes exploram vulnerabilidades em DIDs, chaves criptograficas e protocolos de registro e essencial para projetar arquiteturas resilientes. Vamos analisar vetores de ataque reais, entender suas mecanicas e discutir estrategias de mitigacao fundamentadas em criptografia aplicada.
