# Aula 2.2: Divulgacao seletiva (selective disclosure) e predicados

## Abertura
Bem-vindo a aula 2.2! Na aula anterior, vimos como Zero-Knowledge Proofs permitem provar afirmacoes sem revelar informacoes subjacentes. Agora, aplicamos esse conceito diretamente ao ecossistema de Verifiable Credentials: a divulgacao seletiva permite que o holder revele apenas os atributos necessarios de uma credencial, enquanto predicados permitem provar condicoes sobre atributos sem expor seus valores reais. Essas tecnicas sao a espinha dorsal da privacidade em identidade descentralizada.
