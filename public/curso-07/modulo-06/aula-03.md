# Aula 6.3: Saude: Dados Medicos Soberanos e Consentimento do Paciente

## Abertura
Bem-vindo a aula 6.3! Nas aulas anteriores, exploramos como a identidade descentralizada transforma documentos pessoais e credenciais educacionais. Agora, entramos em um dos territorios mais sensiveis e impactantes: a saude. Dados medicos sao, simultaneamente, os mais pessoais e os mais fragmentados entre todos os dados que produzimos ao longo da vida. A identidade descentralizada oferece um novo paradigma onde o paciente se torna o verdadeiro dono de seu historico medico.
...
## Proxima Aula
Na proxima aula, vamos iniciar o Modulo 7 e explorar como a identidade descentralizada se aplica ao mundo financeiro. Estudaremos financas descentralizadas (DeFi) e centralizadas (CeFi), com foco em KYC reutilizavel e como credenciais verificaveis podem conectar o mundo financeiro regulado com o ecossistema cripto. Ate la!
