# Aula 7.4: Armazenamento seguro: Encrypted Data Vaults (EDV) e Identity Hubs

## Abertura
Bem-vindo a aula 7.4! Nesta aula, vamos estudar as arquiteturas de armazenamento seguro para dados de identidade descentralizada. Veremos como Encrypted Data Vaults (EDV) e Identity Hubs resolvem o problema de armazenar credenciais, documentos pessoais e dados sensiiveis de forma criptografada, replicavel e sob controle total do usuario, eliminando a dependencia de provedores centralizados.
...
## Proxima Aula
Na proxima aula, vamos iniciar o Modulo 8 com o tema Ponte Web2-Web3: OIDC4VC (OpenID Connect para credenciais verificaveis). Veremos como os protocolos OpenID Connect estao sendo estendidos para suportar emissao e apresentacao de credenciais verificaveis, criando uma ponte entre sistemas de identidade tradicionais e descentralizados. Ate la!
